        ...
        <div class="container-fluid mt-2">
            ...
            <div class="row container-fluid">
                ...
                <div class="col-md-6">
                    <h4>Edit Profile</h4>
                    <hr>
                    <form action="/mhs/simpanNIM">
                        <div class="form-group">
                            <label for="" class="font-weight-bold">Email</label>
                            <input type="hidden" name="id" class="form-control" readonly="readonly" value="{{ $mahasiswa->id }}">
                            <input type="text" class="form-control" readonly="readonly" value="{{ $mahasiswa->email }}">
                        </div>
                        <div class="form-group">
                            <label for="" class="font-weight-bold">Nama</label>
                            <input type="text" class="form-control" readonly="readonly" value="{{ $mahasiswa->nama }}">
                        </div>
                        <div class="form-group">
