...
<html lang="en">
  <head>
    ...
    <title>SIKP | Verifikasi Surat Keterangan KP</title>
  </head>
  <body>
    ...
    <header>
      ...
      <main>
        <div class="container-fluid mt-2">
            <h2><i class="fas fa-file mr-2"></i>Verifikasi Surat Keterangan KP</h2>
            ...
            <div class="container-fluid">
                <table class="table table-striped">
                    ...
                    @php $no=1; @endphp
                    @foreach($suratket as $skp)
                    <tbody>
                      <tr>
                        <th scope="row"><?php echo $no++ ?></th>
                        <td>@php echo $skp->nim  @endphp</td>
                        <td></td>
                        <td>@php echo $skp->lembaga  @endphp</td>
