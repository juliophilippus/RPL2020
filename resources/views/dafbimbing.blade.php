...
<html lang="en">
  <head>
    ...
    <title>SIKP | Daftar Bimbingan</title>
  </head>
  <body>
    ...
    <header>
      ...
      <main>
        <div class="container-fluid mt-2">
            <h2><i class="fas fa-user-graduate mr-2"></i>Daftar Bimbingan</h2>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>KP</td>
                        <td>UKDW</td>
                        <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Set Pengajuan Ujian KP</button></td>
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          ...
                          <div class="modal-content">
                              ...
                              <h5 class="modal-title" id="exampleModalLabel">Set Pengajuan Ujian KP</h5>
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                              </button>
                              </div>
                              <div class="modal-body">
                                <p>Apa anda yakin mengajukan ujian mahasiswa ini?</p>
                              </div>
