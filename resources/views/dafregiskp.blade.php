...
<html lang="en">
  <head>
    ...
    <title>SIKP | Daftar Registrasi KP</title>
  </head>
  <body>
    ...
    <header>
      ...
      <main>
        <div class="container-fluid mt-2">
            <h2><i class="fas fa-user-graduate mr-2"></i>Daftar Mahasiswa KP</h2>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>Mahasiswa</td>
                        <td>UKDW</td>
                        <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Set Batas KP</button></td>
                                ...
                                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <h5 class="modal-title" id="exampleModalLabel">Set Batas KP</h5>
                                        ...
                                        <form action="">
                                            <div class="form-group">
                                                <label for="">Tanggal Batas KP</label>
