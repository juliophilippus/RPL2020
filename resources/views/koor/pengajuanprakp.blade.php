...
<html lang="en">
  <head>
    ...
    <title>SIKP | Verifikasi Pengajuan Pra KP</title>
  </head>
  <body>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                      @foreach($prakp as $key)
                        ...
                        <td>
                            @if($key->status == 0)
                                <a href="/koor/prosessetujuiprakp/{{ $key->id_prakp }}" class="btn btn-success">Setujui</a>
                            @else
                                <a href="/koor/prosesbatalprakp/{{ $key->id_prakp }}" class="btn btn-danger">Batalkan Persetujuan</a>
                            @endif
                        </td>
                          </tr>                                
                        @endforeach
