...
<html lang="en">
  <head>
    ...
    <title>SIKP | Verifikasi Surat Keterangan</title>
  </head>
  <body>
    ...
    <header>
      ...
      <main>
        <div class="container-fluid mt-2">
            <h2><i class="fas fa-calendar-alt mr-2"></i>Persetujuan Surat Keterangan</h2>
            <!-- Form -->
            <div class="container-fluid">
                    ...
                    <tbody>
                        @foreach($sk as $key)
                          <tr>
                            ...
                            <td>
                                @if($key->status == 0)
                                    <a href="/koor/prosessetujuisk/{{ $key->id_skp }}" class="btn btn-success">Setujui</a>
                                @else
                                    <a href="/koor/prosesbatalsk/{{ $key->id_skp }}" class="btn btn-danger">Batalkan Persetujuan</a>
                                @endif
                            </td>
                          </tr>                                
                        @endforeach
